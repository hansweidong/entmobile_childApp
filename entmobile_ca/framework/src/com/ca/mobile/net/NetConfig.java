...
public class NetConfig {
	...
	private static NetConfig defaultConfig = new NetConfig(){{
		setCharset("utf-8");
		setTime(30 * 1000);
	...
	public String toString() {
		return "NetConfig [content_type_web=" + content_type_web + ", isHttps=" + isHttps + ", method=" + method  + ", charset=" + charset + ", time=" + time  + ", request_type=" + request_type + ", name_space=" + name_space + ", timeout=" + timeout + ", files=" + files + ", isCookies=" + isCookies + ", key=" + key + "]";
	}
